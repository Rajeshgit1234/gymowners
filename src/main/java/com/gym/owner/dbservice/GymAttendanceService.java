...
public class GymAttendanceService {
    ...
    }public List<Map<String, Object>>  fetchFullGymAttendance(int gymId,int year,int doy,int doyend) {
        return gymAttendanceRepo.fetchFullGymAttendance(gymId, Common.GYM_CUSTOMERS,doy,doyend);
